...
export const metadata: Metadata = {
  title: "Speakers",
  description: "Plenary, Keynote, and Invited speakers presenting at ICAAD 2026.",
}
  ...
  return (
    <div className="pt-24 pb-10 min-h-screen bg-brand-bg">
      <PageHeader
        ...
        description="Pioneering researchers, global scholars, and technology leaders presenting at ICAAD 2026."
      />
              ...
              {cat.speakers.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="md:col-span-8 flex flex-col justify-between">
                        <div>
                          ...
                          {speaker.topic && (
                            <div className="mb-5 bg-brand-surface border-l-2 border-brand-gold p-3.5 rounded-sm">
                              <span className="font-mono text-[10px] uppercase tracking-wider text-brand-gold font-bold block mb-0.5">Presentation Topic</span>
                              <span className="font-display font-medium text-brand-black text-base">{speaker.topic}</span>
                            </div>
                          )}
                ...
                <div className="bg-white border border-brand-border p-8 md:p-12 text-center shadow-soft">
                  ...
                  <h4 className="text-lg font-display font-semibold text-brand-black mb-2">
                    {cat.title} Will Be Announced
                  </h4>
                  <p className="text-sm font-light text-brand-blackLight max-w-lg mx-auto leading-relaxed">
                    Invited speakers representing disciplinary tracks and partner academic institutions are being finalized and will be published soon.
                  </p>
                </div>
              )}
            </div>
