  ...
  tracks: [
    {
      ...
      topics: [
        { name: "Smart Systems & Autonomous Technologies", nameAr: "الأنظمة الذكية والتقنيات المستقلة", nameTr: "Akıllı Sistemler ve Otonom Teknolojiler" },
        { name: "Natural Language Processing & Large Language Models", nameAr: "معالجة اللغة الطبيعية والنماذج اللغوية الكبيرة", nameTr: "Doğal Dil İşleme ve Büyük Dil Modelleri" },
        { name: "AI in Physical & Chemical Sciences", nameAr: "الذكاء الاصطناعي في العلوم الفيزيائية والكيميائية", nameTr: "Fiziksel ve Kimyasal Bilimlerde Yapay Zeka" },
        { name: "Mathematical Modeling & Computational Biology", nameAr: "النمذجة الرياضية والبيولوجيا المحوسبة", nameTr: "Matematiksel Modelleme ve Hesaplamalı Biyoloji" },
        { name: "Data Science & Big Data Analytics", nameAr: "علوم البيانات وتحليل البيانات الضخمة", nameTr: "Veri Bilimi ve Büyük Veri Analitiği" },
        { name: "Computer Vision & Image Processing", nameAr: "الرؤية الحاسوبية ومعالجة الصور", nameTr: "Bilgisayarlı Görme ve Görüntü İşleme" },
      ],
    },
    {
      id: "health",
      ...
      topics: [
        { name: "AI in Clinical Decision Support Systems", nameAr: "الذكاء الاصطناعي في أنظمة دعم القرارات السريرية", nameTr: "Klinik Karar Destek Sistemlerinde YZ" },
        { name: "AI in Drug Discovery & Development", nameAr: "الذكاء الاصطناعي في اكتشاف الأدوية وتطويرها", nameTr: "İlaç Keşfi ve Geliştirmede YZ" },
        { name: "AI in Medical Image Analysis", nameAr: "الذكاء الاصطناعي في تحليل الصور الطبية", nameTr: "Tıbbi Görüntü Analizinde YZ" },
        { name: "Natural Language Processing in Medicine", nameAr: "معالجة اللغة الطبيعية في الطب", nameTr: "Tıpta Doğal Dil İşleme" },
        { name: "Ethical & Legal Issues in Medical AI", nameAr: "القضايا الأخلاقية والقانونية في الذكاء الاصطناعي الطبي", nameTr: "Tıbbi Yapay Zekada Etik ve Yasal Sorunlar" },
      ],
    },
    {
      id: "agriculture",
      ...
      topics: [
        { name: "Smart Agriculture & Precision Farming", nameAr: "الزراعة الذكية والدقيقة", nameTr: "Akıllı Tarım ve Hassas Tarım" },
        { name: "AI for Crop Monitoring & Yield Prediction", nameAr: "الذكاء الاصطناعي لمراقبة المحاصيل والتنبؤ بالإنتاج", nameTr: "Bitki İzleme ve Verim Tahmini için YZ" },
        { name: "Climate-Smart Agriculture & Sustainability", nameAr: "الزراعة المستدامة والمقاومة للتغير المناخي", nameTr: "İklim Dostu Tarım ve Sürdürülebilirlik" },
        { name: "AI for Food Supply Chain & Traceability", nameAr: "الذكاء الاصطناعي في سلاسل إمداد الأغذية وتتبعها", nameTr: "Gıda Tedarik Zinciri ve İzlenebilirlik için YZ" },
        { name: "Predictive Modeling for Agricultural Systems", nameAr: "النمذجة التنبؤية للأنظمة الزراعية", nameTr: "Tarım Sistemleri için Tahmin Modellemesi" },
      ],
    },
    {
      id: "law",
      ...
      topics: [
        { name: "Privacy, Data Protection, KVKK & GDPR", nameAr: "الخصوصية وحماية البيانات و GDPR", nameTr: "Gizlilik, Veri Koruma ve KVKK, GDPR" },
        { name: "AI & Human Rights", nameAr: "الذكاء الاصطناعي وحقوق الإنسان", nameTr: "Yapay Zeka ve İnsan Hakları" },
        { name: "Ethics & Responsible AI", nameAr: "الأخلاقيات والذكاء الاصطناعي المسؤول", nameTr: "Etik ve Sorumlu Yapay Zeka" },
        { name: "AI in Judicial & Legal Decision Making", nameAr: "الذكاء الاصطناعي في اتخاذ القرارات القضائية والقانونية", nameTr: "Yargısal ve Hukuki Karar Almada YZ" },
        { name: "Intellectual Property in the AI Era", nameAr: "الملكية الفكرية في عصر الذكاء الاصطناعي", nameTr: "Yapay Zeka Çağında Fikri Mülkiyet" },
      ],
    },
    {
      id: "economics",
      ...
      topics: [
        { name: "AI in Economics & Finance", nameAr: "الذكاء الاصطناعي في الاقتصاد والمالية", nameTr: "Ekonomi ve Finansta Yapay Zeka" },
        { name: "Smart Financial Technologies (FinTech)", nameAr: "التقنيات المالية الذكية (FinTech)", nameTr: "Akıllı Finans Teknolojileri (FinTech)" },
        { name: "Digital Transformation & Smart Enterprises", nameAr: "التحول الرقمي والمؤسسات الذكية", nameTr: "Dijital Dönüşüm ve Akıllı İşletmeler" },
        { name: "Business Intelligence & Big Data Analytics", nameAr: "ذكاء الأعمال وتحليل البيانات الضخمة", nameTr: "İş Zekası ve Büyük Veri Analitiği" },
        { name: "AI in Sustainable Economic Development", nameAr: "الذكاء الاصطناعي في التنمية الاقتصادية المستدامة", nameTr: "Sürdürülebilir Ekonomik Kalkınmada YZ" },
      ],
    },
    {
      id: "social-sciences",
      ...
      topics: [
        { name: "Societal Impacts of Artificial Intelligence", nameAr: "الآثار المجتمعية للذكاء الاصطناعي", nameTr: "Yapay Zekanın Toplumsal Etkileri" },
        { name: "AI Governance & Public Policy", nameAr: "حوكمة الذكاء الاصطناعي والسياسة العامة", nameTr: "Yapay Zeka Yönetişimi ve Kamu Politikası" },
        { name: "AI & Transformation of Educational Systems", nameAr: "الذكاء الاصطناعي وتحول الأنظمة التعليمية", nameTr: "Yapay Zeka ve Eğitim Sistemleri Dönüşümü" },
        { name: "Digital Ethics", nameAr: "الأخلاقيات الرقمية", nameTr: "Dijital Etik" },
        { name: "AI & Social Behavior Analysis", nameAr: "الذكاء الاصطناعي وتحليل السلوك الاجتماعي", nameTr: "Yapay Zeka ve Sosyal Davranış Analizi" },
      ],
    },
    {
      ...
      topics: [
        { name: "Epistemology & Philosophy of Artificial Intelligence", nameAr: "إبستيمولوجيا وفلسفة الذكاء الاصطناعي", nameTr: "Yapay Zekanın Epistemolojisi ve Felsefesi" },
        { name: "Digital Sociology & AI Social Structures", nameAr: "علم الاجتماع الرقمي والهياكل الاجتماعية للذكاء الاصطناعي", nameTr: "Dijital Sosyoloji ve YZ Sosyal Yapıları" },
        { name: "AI Ethics, Morality & Value Alignment", nameAr: "أخلاقيات الذكاء الاصطناعي وتوافق القيم", nameTr: "YZ Etiği, Ahlak ve Değer Uyumlaması" },
        { name: "Human-Machine Coexistence & Posthumanism", nameAr: "التعايش بين الإنسان والآلة ومابعد الإنسانية", nameTr: "İnsan-Makine Birlikteliği ve Posthümanizm" },
        { name: "Social Change & Algorithmic Governance", nameAr: "التغير الاجتماعي والحوكمة الخوارزمية", nameTr: "Sosyal Değişim ve Algoritmik Yönetişim" },
      ],
    },
    {
      id: "art-design",
      ...
      topics: [
        { name: "Generative AI in Visual & Performing Arts", nameAr: "الذكاء الاصطناعي التوليدي في الفنون البصرية والمسرحية", nameTr: "Görsel ve Sahne Sanatlarında Üretken Yapay Zeka" },
        { name: "AI-Driven Design & Architecture", nameAr: "التصميم والمعمار المدعوم بالذكاء الاصطناعي", nameTr: "Yapay Zeka Destekli Tasarım ve Mimarlık" },
        { name: "Computational Aesthetics & Art Theory", nameAr: "الجماليات المحوسبة ونظرية الفن", nameTr: "Hesaplamalı Estetik ve Sanat Teorisi" },
        { name: "Interactive Digital Media & Gaming", nameAr: "الوسائط الرقمية التفاعلية والألعاب", nameTr: "İnteraktif Dijital Medya ve Oyun" },
        { name: "AI in Music Composition & Sound Design", nameAr: "الذكاء الاصطناعي في التأليف الموسيقي والتصميم الصوتي", nameTr: "Müzik Besteleme ve Ses Tasarımında Yapay Zeka" },
      ],
    },
    {
      id: "theology",
      ...
      topics: [
        { name: "AI in Religious Texts Analysis & Digital Humanities", nameAr: "الذكاء الاصطناعي في تحليل النصوص الدينية والإنسانيات الرقمية", nameTr: "Dini Metin Analizinde Yapay Zeka ve Dijital Beşeri Bilimler" },
        { name: "Theological Perspectives on Artificial Consciousness", nameAr: "الرؤى الدينية والإلهية حول الوعي الاصطناعي", nameTr: "Yapay Bilinç Üzerine İlahiyat Bakış Açıları" },
        { name: "Machine Morality & Religious Ethics", nameAr: "أخلاقيات الآلة والأخلاق الدينية", nameTr: "Makine Ahlakı ve Dini Etik" },
        { name: "AI, Transhumanism, and Eschatology", nameAr: "الذكاء الاصطناعي، الترانسهومانيزم، والعلم الأخروي", nameTr: "Yapay Zeka, Transhümanizm ve Eskatoloji" },
        { name: "Religious Practices & Digital Rituals in the AI Era", nameAr: "الممارسات الدينية والطقوس الرقمية في عصر الذكاء الاصطناعي", nameTr: "Yapay Zeka Çağında Dini Pratikler ve Dijital Ritüeller" },
      ],
    },
  ],
  navLinks: [
